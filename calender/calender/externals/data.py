...
def make_url_action(label, url, i18n_labels=None):
	...
	if i18n_labels is not None:
		return {"type":"uri", "label":label, "url":url, "i18nLabels": i18n_labels}
...
"""Quick reply(ref:https://developers.worksmobile.com/kr/document/100500807?lang=ko)"""
...
def make_image_carousel_column(image_url=None, image_resource_id = None, action=None, i18n_image_urls = None, i18n_image_resource_ids = None):
	...
	if i18n_image_urls is not None:
		column_data["i18nImageUrls"] = i18n_image_urls #[MakeI18nImageUrl,MakeI18nImageUrl]
	if i18n_image_resource_ids is not None:
		column_data["i18nImageResourceIds"] = i18n_image_resource_ids #[MakeI18nImageResourceId,MakeI18nImageResourceId, ...]
	return column_data
